    ...
    for year in years:
        ...
        for i in range(10,new_df.shape[0]):
            ...
            for j in range(10):
                ...
                gotsum=gotsum+float(new_df.ix[i-j-1,1])
            #print(gotsum)
            avgsum=gotsum/10
        ...
        df_result=df_result[['date','close_10_sma', 'close_10_ema','kdjk_10','kdjd_10','macd','rsi_10','wr_10','cci_10','Momentum','ADOsc','New_Feature','OpenPrice','UpDown']]
